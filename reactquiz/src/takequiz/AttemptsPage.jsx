    ...
    async (page = 1) => {
      try {
        console.log("Fetching attempts", {
          ...
          page,
          pageSize: PAGE_SIZE,
          sortSentToBackend: sortOption,
          searchSentToBackend: searchTerm,
        });
        ...
        // Keep quiz title even when results are empty
        if (attemptsArray.length > 0 && attemptsArray[0].QuizTitle) {
          setQuizTitle(attemptsArray[0].QuizTitle);
        }
          ...
          <div className="row g-4">
            {attempts.map((a) => {
              ...
              const minutes = Math.floor(
                (a.TimeUsedSeconds ?? 0) / 60
              );
              const seconds = (a.TimeUsedSeconds ?? 0) % 60;
                ...
                <div className="col-md-4" key={a.QuizResultId}>
                  <div className={`card shadow-sm h-100 ${bgColor}`}>
                    <div className="card-body d-flex flex-column justify-content-center align-items-center text-center">
                      ...
                      <p className="card-text mb-2">Percent: {percentage}%</p>
                      <p className="card-text mb-1">
